...
<div class="col-sm-12 col-lg-offset-3">
 <form class="col-sm-6" action="clientcontroller.php" method="post" accept-charset="utf-8" enctype="multipart/form-data">
 		...
 		<div class="text-center">
	 		...
	 		<br>
	 		<label for="birthmonth">Birthday Month:&nbsp;</label><input id="birthmonth" type="range" min="1" max="12" step="1" onchange="printValue('#birthmonth','#bmonth');" /><input id='bmonth' type='month' size='2'/><br>
